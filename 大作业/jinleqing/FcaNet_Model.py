...
class FcaBasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        c2wh = dict([(64,32), (128,32), (256,16) ,(512,8)])
        self.planes = planes
...
class FcaBasicBlock_normal(nn.Module):
    expansion = 1
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
                 ...
                 *, reduction=16, ):
        global _mapper_x, _mapper_y
        super(FcaBasicBlock_normal, self).__init__()
...
def fcanet(num_classes=100,pretrained=False):

    model = ResNet(FcaBasicBlock, [2, 2, 2, 2], num_classes=num_classes)
    return model

def fcanet_normal(num_classes=100,pretrained=False):

    model = ResNet_normal(FcaBasicBlock_normal, [2, 2, 2, 2], num_classes=num_classes)
    return model